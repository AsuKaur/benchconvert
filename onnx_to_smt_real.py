...
def onnx_to_smt_real(onnx_path, vnnlib_path, smt_path):
...
Directory Structure:
  ...
  smt_real/            - Generated SMT-LIB files will be saved here

Examples:
  python onnx_to_smt_real.py model      # Convert onnx/model.onnx + vnnlib/model.vnnlib -> smt_real/model.smt2
  python onnx_to_smt_real.py --all      # Convert all matching ONNX+vnnlib pairs
        """
    )
