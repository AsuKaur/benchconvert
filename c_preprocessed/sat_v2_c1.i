# 1 "c_network/sat_v2_c1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 465 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "c_network/sat_v2_c1.c" 2
# 13 "c_network/sat_v2_c1.c"
...
# 18 "c_network/sat_v2_c1.c" 2
# 29 "c_network/sat_v2_c1.c"
...
static inline void node__0_Gemm( const float A[1][2], const float B[5][2], const float C[5], float Y[1][5] )
{
...
static inline void node__1_Relu( const float X[1][5], float Y[1][5] )
{
...
static inline void node__2_Gemm( const float A[1][5], const float B[2][5], const float C[2], float Y[1][2] )
{
