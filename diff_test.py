...
def test_single_model(model_name, num_tests=100, tolerance=1e-5):
...
def test_all_models_in_folder(onnx_folder, num_tests=100, tolerance=1e-5):
...
Examples:
  ...
  python diff_test.py --folder models/ --num-tests 50 --tolerance 1e-6
    ...
    if args.model_name:
        ...
        test_single_model(args.model_name, args.num_tests, args.tolerance)
    elif args.folder:
        # Batch testing
        test_all_models_in_folder(args.folder, args.num_tests, args.tolerance)
